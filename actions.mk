...
install_prefix = $(install_dir)/opt/fastcdr
debian_dir = $(stage_dir)/DEBIAN
control_file = $(debian_dir)/control
maintainer = you@example.com
description = Fast-CDR

all: clone build stage control package

clone:
	git clone --branch=$(BRANCH) --depth=1 https://github.com/eProsima/Fast-CDR.git src
